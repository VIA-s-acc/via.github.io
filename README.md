...
[Торговец](#Торговец)\
[Снятие С Продажи](#Снятие-С-Продажи)\
...
[Цвет](#Цвет)\
[Получить Значки](#Получит-Значки)\
...
`$[market|m|shop] [тип_предмета=Все] [мин_стат=0.0] [макс_цена=1000000]`

Показывает предметы, доступные для покупки на рынке. Можно умно фильтровать предметы с помощью этих параметров.

### Продажа

`$merchall [макс_стат=100] [мин_стат=0]`

Продает все ваши неэкипированные предметы по их стоимости. Удобный способ продать большое количество предметов сразу.

### История Магазина

`$[mh|markethistory|shophistory] [тип_предмета=Все] [мин_стат=0.0] [после_дата=2018-03-17]`
...
Покупает предмет на глобальном рынке. Налог за покупку составляет 5%.

### Продать По Стоимости

`$[merch|merchant] [идентификаторы_предметов...]`

Продает предметы по их стоимости. Предметы, которые вы не владеете, будут отфильтрованы.

### Подтвержденные Предложения

`$pending`

Просмотрите ваши ожидающие предложения в магазине.

### Торговец

`$trader`

Покупает предметы у торговца. Цена за предмет составляет 50 раз его стат.
...
Снимает предмет с продажи. Вы можете убрать только свои предметы из магазина.

### Продажа Предмета

`$sell <идентификатор_предмета> <цена>`

Выставляет ваш предмет на рынок. Налог за продажу предметов составляет 5% от цены.

### Предложение Торговли

`$offer <идентификатор_предмета> <цена> <пользователь>`

Предлагает предмет конкретному пользователю.
...
Просмотр страницы Patreon бота. Разные уровни подписки предоставляют разные вознаграждения.
